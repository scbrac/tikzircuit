...
\newcommand{\photodiodeSNW}[3]{
    % photo diode in South-North Orientation, Light from West
...
\newcommand{\piezobuzzerWE}[2]{
    ...
    \draw[fill=\fillcolor] #2 ++(0.5,-0.2) -- ++(0.3,-0.2) -- ++(0,0.8) -- ++(-0.3,-0.2);
    \draw[very thick] #2 ++(0.5,-0.25) -- ++(0,0.5);
    \draw #2 ++(0.2,-0.05) rectangle ++(0.2,0.1);
    \draw #2 ++(0.2,-0.1) -- ++(0.2,0);
    \draw #2 ++(0.2,+0.1) -- ++(0.2,0);
}
